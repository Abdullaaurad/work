<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        $sql1 = "SELECT * FROM attendance WHERE Employee_Id='$EmployeeId' ";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Attendance/Attendance.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
</head>
<body>
    <div class="header">
        <h1>Attendance Details of Employee</h1>
    </div>
