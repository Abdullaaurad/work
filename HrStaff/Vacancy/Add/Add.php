        ...
        <div class="form-container">
            <div class="col-50">
                <div class="header">
                    ...
                    <input type="text" id="Qualification" name="Qualification" maxlength="100" size="70%" required><br>
                    ...
                    <input type="text" id="Salary_Range" name="Salary_Range" maxlength="50" required><br>
