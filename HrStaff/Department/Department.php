...
<body>
    ...
    <div class="button-container">
        <form action="../Hr Staff.php" method="post" style="display: inline-block; width: 40%;">
            <Input type="hidden" name="EmployeeId" value="<?php echo $EmployeeId; ?>">
            <button type="submit" class="btn info">Back</button>
        </form>
        <form action="./Add department.php" method="post" style="display: inline-block; width: 20%; ">
            <Input type="hidden" name="EmployeeId" value="<?php echo $EmployeeId; ?>">
            <button type="submit" class="btn info">Add department</button>
        </form>
        <form action="./Edit department.php" method="post" style="display: inline-block; width: 65%;">
            <Input type="hidden" name="EmployeeId" value="<?php echo $EmployeeId; ?>">
            <button type="submit" class="btn info">Edit department</button>
