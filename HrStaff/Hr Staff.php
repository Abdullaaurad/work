...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Hr Staff.css">
...
<body>
    ...
    <form action="../Info/About.php" method="post" >
        ...
        <form action="./Employee/Employee.php" method="post" style="text-align: right;">
        <input type="hidden" name="EmployeeId" value="<?php echo $EmployeeId; ?>">
        <button class="btn co">View Employee Information</button>
    </form>
    <br>
    ...
    <div class="w3-card-4" style="width:40%; float: left;">
        ...
        <div class="w3-container w3-white">
            <H4>View All the Job Applications</H4>
        </div>
        <footer class="w3-container w3-white" style="text-align: right;">
            <br>
    ...
    <div class="w3-card-4" style="width:40%; float: left; margin-right: 10px;">
        ...
        <div class="w3-container w3-white">
            <H4>Add delete or Edit Job</H4>
        </div>
        <footer class="w3-container w3-white" style="text-align: right;">
            <br>
            <form action="./Employee/Job/Job.php" method="post">
                <button type="submit" class="btn info">View</button>
                <input type="hidden" name="EmployeeId" value="<?php echo $receivedVariable; ?>">
            </form>
            <br>
    ...
    <form action="../index.php" method="post" style="text-align: right;">
        <input type="hidden" name="EmployeeId" value="<?php echo $receivedVariable; ?>">
        <button class="btn view" text-align="right";>Log Out</button>
    </form>
    <br>
</body>
</html>
