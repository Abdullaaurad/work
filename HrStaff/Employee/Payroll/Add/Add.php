        ...
        <div class="form-container">
            <div class="col-50">
                <div class="header">
                    ...
                    <input type="number" id="Salary" name="Salary" maxlength="8"  required><br>

                    <label for="Bonus"><i class="fa fa-calendar"></i>Bonus</label>
                    <input type="number" id="Bonus" name="Bonus" maxlength="8" required><br>

                    <label for="Allowance"><i class="fa fa-calendar"></i>Allowance</label>
                    <input type="number" id="Allowance" name="Allowance" maxlength="8" required><br>

                    <label for="Employee_Id"><i class="fa fa-venus-mars"></i> Employee Id</label>
                    <input type="text" id="Employee_Id" name="Employee_Id"  maxlength="12" required><br>
                    <br>
                </div>
